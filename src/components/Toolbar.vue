...
const btn =
  'rounded-md border border-zinc-700 bg-zinc-800 px-3 py-1.5 text-sm text-zinc-200 transition-colors hover:border-zinc-500 hover:bg-zinc-700'
const btnPrimary =
  ...
  <div class="flex flex-wrap items-center gap-2 border-b border-zinc-800 px-4 py-3">
    ...
    <div class="ml-auto flex items-center gap-3">
      <label class="flex items-center gap-2 text-sm text-zinc-400">
        ...
        <select
          v-model="indent"
          class="rounded-md border border-zinc-700 bg-zinc-800 px-2 py-1.5 text-sm text-zinc-200"
        >
      ...
      <span
        ...
        :class="valid ? 'bg-emerald-500/15 text-emerald-400' : 'bg-rose-500/15 text-rose-400'"
      >
        {{ valid ? 'Valid' : 'Invalid' }}
      </span>
    </div>
